      ...
      <Fragment>
        <div>
          ...
          <Button
            ...
            value="Scientific"
            wide
            onButtonClick={this.toggleScientificMode}
          />
        </div>
        <div>
        ...
        <div>
          ...
          />
          {this.state.isScientificModeOn && (
            <Button label="^" value="^" wide onButtonClick={onButtonClick} />
          )}
        </div>
        <div>
          ...
          {({ changeToLightTheme, changeToDarkTheme }) => (
            <div>
              <Button
                ...
                value="light"
                wide
                onButtonClick={changeToLightTheme}
              />
              <Button
                label="Dark mode"
                value="dark"
                wide
                onButtonClick={changeToDarkTheme}
              />
            </div>
          )}
        </ThemeContext.Consumer>
